<div class="profile-sidebar">
    <div class="profile-sidebar__user">
        <a class="profile-sidebar--thumb" href="/profile">
            <div class="shopee-avatar">
                ...
                <img class="shopee-avatar__img" src="https://cdn-icons-png.flaticon.com/512/149/149071.png">
    ...
    <div class="profile-sidebar--menu">
            ...
            <div class="stardust-dropdown__item-header">
                <a class="profile-sidebar--menu-item" href="/voucher-wallet">
                    <div class="profile-sidebar--menu-item--icon">
                        <img src="https://mwc.com.vn/Assets/App/images/general/new-user.png" alt="">
                    </div>
                    <div class="profile-sidebar--menu-item--title">
                        <span class="profile-sidebar--menu-item--text">Ưu đãi dành riêng cho
                            bạn</span>
        ...
        <div class="stardust-dropdown stardust-dropdown--open">
            <div class="stardust-dropdown__item-header">
                <a class="profile-sidebar--menu-item" href="/profile">
                    ...
                    <div class="profile-sidebar--menu-item--title">
                        <span class="profile-sidebar--menu-item--text">Tài khoản của
                            tôi</span>
                    </div>
                </a>
            </div>
            <div class="stardust-dropdown__item-body stardust-dropdown__item-body--open">
                <div class="profile-sidebar--submenu">
                    <a class="profile-sidebar--submenu-item profile-sidebar--submenu-item--active" id="profile"
                        href="/index.php?pages=product_detail&action=layout&html=setting">
                        <span class="profile-sidebar--submenu-item__text">Hồ sơ</span>
                    </a>
                    <a class="profile-sidebar--submenu-item" id="password"
                        href="/index.php?pages=product_detail&action=layout&html=changePassword_se">
                        <span class="profile-sidebar--submenu-item__text">Đổi mật
                            khẩu</span>
                    </a>
                    <a class="profile-sidebar--submenu-item" id="password"
                        href="/index.php?pages=product_detail&action=layout&html=forgotpass">
                        <span class="profile-sidebar--submenu-item__text">Quên Mật Khẩu</span>
                    </a>
                </div>
            </div>
        </div>
        <div class="stardust-dropdown">
            <div class="stardust-dropdown__item-header">
                <a class="profile-sidebar--menu-item "
                    href="/index.php?pages=product_detail&action=layout&html=orderuser_setting" id="purchase">
                    <div class="profile-sidebar--menu-item--icon">
                        <img src="https://banner2.cleanpng.com/20190622/fxr/kisspng-purchase-order-computer-icons-clip-art-vector-grap-customer-vector-retail-transparent-amp-png-clipa-5d0e56b7278664.1633278315612207911619.jpg"
                            alt="">
                    </div>
                    <div class="profile-sidebar--menu-item--title">
        ...
        <div class="stardust-dropdown">
            <div class="stardust-dropdown__item-header">
                <a class="profile-sidebar--menu-item" href="/notifications" id="notifications">
                    <div class="profile-sidebar--menu-item--icon">
                        <img src="https://banner2.cleanpng.com/20180401/ayq/kisspng-computer-icons-announcement-5ac0db885dd4e6.0089022615225885523843.jpg"
                            alt="">
                    </div>
                    <div class="profile-sidebar--menu-item--title">
        ...
        <div class="stardust-dropdown">
            <div class="stardust-dropdown__item-header">
                <a class="profile-sidebar--menu-item" href="/index.php?pages=product_detail&action=layout&html=logout">
                    <div class="profile-sidebar--menu-item--icon">
                        <img src="https://media.istockphoto.com/id/1183693178/vi/vec-to/tho%C3%A1t-ho%E1%BA%B7c-%C4%91%C4%83ng-nh%E1%BA%ADp-%C4%91%C4%83ng-xu%E1%BA%A5t-bi%E1%BB%83u-t%C6%B0%E1%BB%A3ng-c%C3%B4-l%E1%BA%ADp-tr%C3%AAn-m%C3%A0u-tr%E1%BA%AFng-m%C5%A9i-t%C3%AAn-tr%C3%B2n-b%C3%AAn-ph%E1%BA%A3i-m%C3%A0u.jpg?s=612x612&w=0&k=20&c=P8WD9bJGEEgX4exit4h8xcXUGr2ksqqJfrSGs7hztrw="
                            alt="">
                    </div>
                    <div class="profile-sidebar--menu-item--title">
